...
public class EvChargerInfo {
	...
	public EvChargerInfo(String statNm, String statId, String chgerId, String chgerType, String addr, String location,
			String lat, String lng, String useTime, String busiId, String bnm, String busiNm, String busiCall,
			String stat, String statUpdDt, String lastTsdt, String lastTedt, String nowTsdt, String powerType,
			String output, String method, String zcode, String zscode, String kind, String kindDetail,
			String parkingFree, String note, String limitYn, String limitDetail, String delYn, String delDetail) {
		super();
		this.statNm = statNm;
		this.statId = statId;
	...
	public String toString() {
		return "EvChargerInfo [statNm=" + statNm + ", statId=" + statId + ", chgerId=" + chgerId + ", chgerType="
				+ chgerType + ", addr=" + addr + ", location=" + location + ", lat=" + lat + ", lng=" + lng
				+ ", useTime=" + useTime + ", busiId=" + busiId + ", bnm=" + bnm + ", busiNm=" + busiNm + ", busiCall="
				+ busiCall + ", stat=" + stat + ", statUpdDt=" + statUpdDt + ", lastTsdt=" + lastTsdt + ", lastTedt="
				+ lastTedt + ", nowTsdt=" + nowTsdt + ", powerType=" + powerType + ", output=" + output + ", method="
				...
				+ limitDetail + ", delYn=" + delYn + ", delDetail=" + delDetail + "]";
	}
